...
# local dependencies
from src.config import PAIR_WITH, TIME_DIFFERENCE, RECHECK_INTERVAL, CHANGE_IN_PRICE, coins_bought, MAX_COINS, QUANTITY, \
    session_profit, historical_prices, hsp_head, volatility_cooloff
